...
for i = 2:Nx-1
        ...
        %Compute RHS of PDES
        dw(i,j) = a - w(i,j) - w(i,j)*b(i,j)^2 + nu*gradwx(i,j) - Ux*gradwx(i,j) - Uy*gradwy(i,j) + Dw*lapw(i,j);
        db(i,j) = w(i,j)*b(i,j)^2 - beta*b(i,j) + Db*lapb(i,j);
        end
end
